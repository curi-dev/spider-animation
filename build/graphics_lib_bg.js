import * as wasm from './graphics_lib_bg.wasm';
...
export class GraphicsClient {
    ...
    static __wrap(ptr) {
        const obj = Object.create(GraphicsClient.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_graphicsclient_free(ptr);
    }
    /**
    * @param {HTMLImageElement} _image
    */
    constructor(_image) {
        const ret = wasm.graphicsclient_new(addHeapObject(_image));
        return GraphicsClient.__wrap(ret);
    }
    /**
    */
    render() {
        wasm.graphicsclient_render(this.ptr);
    }
}

export function __wbg_log_6c02e094c82de4d8(arg0, arg1) {
...
export function __wbg_getAttribLocation_fcbe16b765cb1de0(arg0, arg1, arg2, arg3) {
...
export function __wbg_subarray_08d3018b69379cb7(arg0, arg1, arg2) {
    const ret = getObject(arg0).subarray(arg1 >>> 0, arg2 >>> 0);
    return addHeapObject(ret);
};
...
export function __wbg_instanceof_Memory_f1dc0d9a83a9c8ea(arg0) {
    let result;
    try {
...
export function __wbindgen_closure_wrapper153(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 10, __wbg_adapter_16);
    return addHeapObject(ret);
};
